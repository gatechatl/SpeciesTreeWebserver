...
//if(move_uploaded_file($_FILES['uploadedfile']['tmp_name'], $input_file)) {
    if(move_uploaded_file($_FILES['uploadfilegenetree']['tmp_name'], $input_file)) {
    }

}

#exec("java -Djava.awt.headless=true GenerateSTARScript " . $original_path);
#exec("R --vanilla < " . $original_path . "script.r");
#chdir("source");
...
$body = "Hi there,\n\nHere's the link to your job:\nhttp://bioinformatics.publichealth.uga.edu/SpeciesTreeAnalysis/STAR/STAR/" . $original_path;
...
#exec("ts -S 19");
exec("ts -n sh runSTARSingle.sh " . $original_path);
#exec("tsSTAR sh runSTAR.sh " . $original_path);
#exec("tsSTAR sh runDisplay.sh " . $original_path);
...
<div class=\"container\">
        <div class=\"top\">
                <a>Species Tree STAR Method Result</a><br /><br />
        </div>
...
<br />
    ...
    <div>
        ...
        <div id=\"download-option\" style=\"display: block;\">
                Save the tree (SVG): <a id=\"download-link\" href=\"#\">Right-click and select \"Save as.. (SVG File)\"</a><br />
                Save as PDF <a href=\"Rplots.pdf\">Click Me</a> <br />
        </div>
...
<!--                        <span class=\"heading1\">Gene Tree Visualization</span><br />
                        <span class=\"heading2\">This might require a modern browser (ie. Chrome, Safari, Firefox) with javascript enabled</span><br />
...
<div class=\"container\" style=\"height:90%;\">
        ...
        <div class=\"content\" style=\"height:87%;\">
                <div class=\"mainpanel\" >
                        ...
                        <span class=\"heading1\">Processing Query <img src=\"../../../images/ajax-loader.gif\" alt=\"some_text\"/></span>
                        <br />
