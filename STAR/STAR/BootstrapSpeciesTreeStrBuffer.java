 ...
 */
public class BootstrapSpeciesTreeStrBuffer
{
   /**
...
//            if (!fileName.contains("__MACOSX")) {
		...
		int total = 0;
		    ...
		    //PrintWriter out2 = new PrintWriter(new BufferedWriter(new FileWriter(bootstrapFolder + "/format_input_pre.tre", true)));

                    //Iterator itr = map.keySet().iterator();
                    //while (itr.hasNext()) {
                    //String fileName = (String)itr.next();
                    //StringBuffer treesbuf = (StringBuffer)map.get(fileName);
                    //	String trees = treesbuf.toString();
