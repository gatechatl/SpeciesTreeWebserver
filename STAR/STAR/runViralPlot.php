...
$param_file = "Output/" . $uniq_id . "/param1.txt";
$input_file2 = "Output/" . $uniq_id . "/data2.txt";
$param_file2 = "Output/" . $uniq_id . "/param2.txt";
$input_file3 = "Output/" . $uniq_id . "/data3.txt";
$param_file3 = "Output/" . $uniq_id . "/param3.txt";
$input_file4 = "Output/" . $uniq_id . "/data4.txt";
$param_file4 = "Output/" . $uniq_id . "/param4.txt";
$input_file5 = "Output/" . $uniq_id . "/data5.txt";
$param_file5 = "Output/" . $uniq_id . "/param5.txt";
...
$input_path = $target_path . "input1/";
$input_path2 = $target_path . "input2/";
$input_path3 = $target_path . "input3/";
$input_path4 = $target_path . "input4/";
$input_path5 = $target_path . "input5/";

exec("chmod a+wrx " . $target_path);
//mkdir ($input_path, 755);
//echo $input_path . "<br />";
exec("mkdir " . $input_path);
exec("chmod a+wrx " . $input_path);
exec("mkdir " . $input_path2);
exec("chmod a+wrx " . $input_path2);
exec("mkdir " . $input_path3);
exec("chmod a+wrx " . $input_path3);
exec("mkdir " . $input_path4);
exec("chmod a+wrx " . $input_path4);
exec("mkdir " . $input_path5);
exec("chmod a+wrx " . $input_path5);


//echo $target_path . "<br />";
$target_path = $original_path . basename( $_FILES['uploadedfile']['name']);
$target_path2 = $original_path . basename( $_FILES['uploadedfile2']['name']);
$target_path3 = $original_path . basename( $_FILES['uploadedfile3']['name']);
$target_path4 = $original_path . basename( $_FILES['uploadedfile4']['name']);
$target_path5 = $original_path . basename( $_FILES['uploadedfile5']['name']);

$backup_highlight_path = "Highlight.txt_original";
$highlight_path = "Highlight.txt";
...
//move_uploaded_file($backup_highlight_path,$highlight_path);
exec("cp Highlight.txt_original Highlight.txt");
move_uploaded_file($_FILES['uploadedfile6']['tmp_name'],$highlight_path);
...
if(move_uploaded_file($_FILES['uploadedfile2']['tmp_name'], $target_path2)) {
    if ($space == 0) {
        $files = $files . $input_file2 . " " . $param_file2;
    } else {
        $files = $files . " " . $input_file2 . " " . $param_file2;
    }
    exec("cp " . $target_path2 . " " . $input_path2);
    $space = 1;
    //echo "The file ".  basename( $_FILES['uploadedfile']['name']).
    //" has been uploaded";
} else{
...
if(move_uploaded_file($_FILES['uploadedfile3']['tmp_name'], $target_path3)) {
    if ($space == 0) {
        $files = $files . $input_file3 . " " . $param_file3;
    } else {
        $files = $files . " " . $input_file3 . " " . $param_file3;

    }
    exec("cp " . $target_path3 . " " . $input_path3);
    $space = 1;
    //echo "The file ".  basename( $_FILES['uploadedfile']['name']).
    //" has been uploaded";
} else{
...
if(move_uploaded_file($_FILES['uploadedfile4']['tmp_name'], $target_path4)) {
    if ($space == 0) {
        $files = $files . $input_file4 . " " . $param_file4;
    } else {
        $files = $files . " " . $input_file4 . " " . $param_file4;

    }
    exec("cp " . $target_path4 . " " . $input_path4);
    $space = 1;
    //echo "The file ".  basename( $_FILES['uploadedfile']['name']).
    //" has been uploaded";
} else{
...
if(move_uploaded_file($_FILES['uploadedfile5']['tmp_name'], $target_path5)) {
    if ($space == 0) {
        $files = $files . $input_file5 . " " . $param_file5;
    } else {
        $files = $files . " " . $input_file5 . " " . $param_file5;

    }
    exec("cp " . $target_path5 . " " . $input_path5);
    $space = 1;
    //echo "The file ".  basename( $_FILES['uploadedfile']['name']).
    //" has been uploaded";
} else{
...
//exec("cp " . $target_path . " " . $input_path);
//echo "<br />";
//echo "cp " . $target_path . " " . $input_path . "<br />";
...
<div class=\"container\" style=\"height:90%;\">
        ...
        <div class=\"content\" style=\"height:150%;\">
                <div class=\"mainpanel\" >
                        <div class=\"register\" >
                        <img src=\"output.png\" alt=\"Output\" height=\"1000\" width=\"900\"/>
                        <br />
                        <br />
