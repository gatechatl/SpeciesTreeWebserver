...
if ($sna_radio == "text") {
    ...
    exec("sh runRemoveMac.sh" . $original_path . "/Bootstrap/SNA.txt " . $original_path . "/Bootstrap/SNA2.txt"); 
} else {
...
#exec("ts -S 5");
exec("ts sh runSTARBoot.sh " . $original_path);
...
<div class=\"container\" style=\"height:2000%;\">
        <div class=\"top\">
                <a>STAR Species Tree BootStrap</a><br /><br />
        </div>
